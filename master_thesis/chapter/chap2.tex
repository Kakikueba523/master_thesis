...
3つの系で同じポテンシャル，同じ結合パラメータを用いて核融合断面積を計算した．図\ref{fig:cljiang_cc_calc_comp}にあるように
...
\node[anchor=west] at (1.5, \EIn) {0 MeV};
...
このガモフピークは2 MeV 程度であり，共鳴構造によって炭素燃焼過程の寿命や中心温度が変化することが指摘された\cite{10.1111/j.1365-2966.2012.20193.x}．
...
そして，X線スーパーバーストの条件は低エネルギーでの\isotope[12]{C} + \isotope[12]{C}
